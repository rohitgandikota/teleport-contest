...
| M1 | Verification loop and dev tooling | [01-verification-loop.md](01-verification-loop.md) | not started | — |
| M2 | Options, rc parsing, chargen | [02-options-and-chargen.md](02-options-and-chargen.md) | not started | — |
...
| M9 | Lua and special levels | [09-lua-and-special-levels.md](09-lua-and-special-levels.md) | not started | — |
...
**Baseline as of 2026-07-24:** upstream skeleton, 0 sessions passing, partial
credit on `seed8000-tourist-starter` only, and that credit is fake — it comes
from `js/fastforward.js` replaying a recorded RNG list.
...
M2 through M5 are one indivisible block in practice: nothing scores until all
four are real, because screen 0 of every session requires chargen, a generated
level, a vision calculation, and a windowport to draw it. Expect the score to sit
near zero through that block and then jump.
