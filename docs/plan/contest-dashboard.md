...
Last refreshed: 2026-08-30T20:10:00.784Z. Local commit: `245ff75`.
...
- Contest phase: open.
- Local checkpoint `245ff75` has not been judged yet; held-out numbers are from the earlier published run.
...
| Startup and per-turn estimate | 64+0.56/turn | 101+0.22/turn |

## Latest local expansion

- The special-room C oracle matches 73793/73793 RNG events and 426/426 screens, cells, and cursors across eleven entry routes.
- Court, swamp, zoo, barracks, hall, nest, morgue, temple, and Delphi messages now match C exactly.
- Room discovery, one-time retirement, level-flag cleanup, wake rolls, and persistent themed-room, vault, and temple state have explicit tests.
- The deterministic corpus covers 105/105 game elements and 126/126 named C branches.
