...
Last refreshed: 2026-09-04T11:35:14.589Z. Local commit: `2f08f440`.
...
- Contest phase: open.
- Local checkpoint `2f08f440` has not been judged yet; held-out numbers are from the earlier published run.
...
| Startup and per-turn estimate | 62+0.42/turn | 65+0.14/turn |
