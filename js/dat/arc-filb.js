// dat/arc-filb.js — Archeologist quest filler, lower half (at or below the
// locate level).
// C ref: dat/Arc-filb.lua
//
// Six ordinary rooms like Arc-fila but with mummies in the upper rooms,
...
export async function arcfilb_level() {
    const des = {
        room: (o) => lspo_room(o),
