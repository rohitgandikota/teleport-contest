// dat/mon-fila.js — Monk quest filler, upper half (above the locate
// level).
// C ref: dat/Mon-fila.lua
//
// Six ordinary rooms with E's, a xorn, an X and earth elementals, joined
// by the standard corridor pass.

import { lspo_room, lspo_stair, lspo_object, lspo_trap, lspo_monster,
         lspo_random_corridors } from '../sp_lev.js';

export async function monfila_level() {
    const des = {
        room: (o) => lspo_room(o),
