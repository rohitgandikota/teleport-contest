// dat/tou-fila.js — Tourist quest filler, upper half (above the locate
// level).
// C ref: dat/Tou-fila.lua
//
// A walled smoothed cavern (random lit) with soldiers, an H and a C.

import { lspo_level_flags, lspo_level_init, lspo_stair,
         lspo_object, lspo_trap, lspo_monster } from '../sp_lev.js';

export async function toufila_level() {
    const des = {
