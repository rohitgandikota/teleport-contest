...
async function movemon_singlemon(mtmp) {
    ...
    /* src/mon.c:1248 m_everyturn_effect() — fog clouds shed harmless vapor;
       no fog cloud has been generated by anything ported yet. */
    if (mtmp.mnum === PMNAMES.PM_FOG_CLOUD)
        (game.unported ||= new Set()).add('movemon:m_everyturn_effect');
