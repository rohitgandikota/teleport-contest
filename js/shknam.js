...
export const shtypes = [
    { name: 'general store', annotation: null, symb: OCLASSES.RANDOM_CLASS, prob: 42,
      iprobs: [[100, OCLASSES.RANDOM_CLASS]] },
    { name: 'used armor dealership', annotation: 'armor shop', symb: OCLASSES.ARMOR_CLASS, prob: 14,
      iprobs: [[90, OCLASSES.ARMOR_CLASS], [10, OCLASSES.WEAPON_CLASS]] },
    { name: 'second-hand bookstore', annotation: 'scroll shop', symb: OCLASSES.SCROLL_CLASS, prob: 10,
      iprobs: [[90, OCLASSES.SCROLL_CLASS], [10, OCLASSES.SPBOOK_CLASS]] },
    { name: 'liquor emporium', annotation: 'potion shop', symb: OCLASSES.POTION_CLASS, prob: 10,
      iprobs: [[100, OCLASSES.POTION_CLASS]] },
    { name: 'antique weapons outlet', annotation: 'weapon shop', symb: OCLASSES.WEAPON_CLASS, prob: 5,
      iprobs: [[90, OCLASSES.WEAPON_CLASS], [10, OCLASSES.ARMOR_CLASS]] },
    { name: 'delicatessen', annotation: 'food shop', symb: OCLASSES.FOOD_CLASS, prob: 5,
      iprobs: [[83, OCLASSES.FOOD_CLASS], [5, T('POT_FRUIT_JUICE')],
               [4, T('POT_BOOZE')], [5, T('POT_WATER')], [3, T('ICE_BOX')]] },
    { name: 'jewelers', annotation: 'ring shop', symb: OCLASSES.RING_CLASS, prob: 3,
      iprobs: [[85, OCLASSES.RING_CLASS], [10, OCLASSES.GEM_CLASS],
               [5, OCLASSES.AMULET_CLASS]] },
    { name: 'quality apparel and accessories', annotation: 'wand shop', symb: OCLASSES.WAND_CLASS, prob: 3,
      iprobs: [[90, OCLASSES.WAND_CLASS], [5, T('LEATHER_GLOVES')],
               [5, T('ELVEN_CLOAK')]] },
    { name: 'hardware store', annotation: 'tool shop', symb: OCLASSES.TOOL_CLASS, prob: 3,
      iprobs: [[100, OCLASSES.TOOL_CLASS]] },
    { name: 'rare books', annotation: 'bookstore', symb: OCLASSES.SPBOOK_CLASS, prob: 3,
      iprobs: [[90, OCLASSES.SPBOOK_CLASS], [10, OCLASSES.SCROLL_CLASS]] },
    { name: 'health food store', annotation: 'vegetarian food shop', symb: OCLASSES.FOOD_CLASS, prob: 2,
    ...
    { name: 'lighting store', annotation: 'lighting shop', symb: OCLASSES.TOOL_CLASS, prob: 0,
